    ...
    <Switch>
      ...
      
      {
        /*
          ...
          ANSWER HERE:This is creating a navigation for the user. The first one will take the user to the tour page. The second one will redirect the user to the section of the page that allows to add. The last one will help the user to edit the tours details.
        */
      }
